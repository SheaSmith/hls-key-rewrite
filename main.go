...
func ffmpegHandler(w http.ResponseWriter, r *http.Request) {
	...
	script := fmt.Sprintf("#!/bin/sh\nexec ffmpeg \\\n-fflags +nobuffer -loglevel fatal -probesize 10M -analyzeduration 0 -fpsprobesize 0 -thread_queue_size 1024 -itsoffset %s \\\n-i \"%s\" \\\n-thread_queue_size 1024 -i \"%s\" -avoid_negative_ts make_zero \\\n-map 0:v \\\n-map 1:a \\\n-c copy \\\n-f mpegts -", delay, v, a)
	fmt.Fprint(w, script)
}
